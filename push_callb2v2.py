...
try:  
    print("Czekam na porzester przycisku na porcie 23")
    GPIO.wait_for_edge(23, GPIO.FALLING)  
    print("Przycisk na porcie 23 przesterowany. Koniec programu")
  
except KeyboardInterrupt:  
    GPIO.cleanup()       # clean up GPIO - CTRL+C 
GPIO.cleanup()           # clean up GPIO - normalne zak. prog. 